...
export const siteList: BuddhistSite[] = [
    {
        ...
        story: [
            "On 15 May 2026, I visited **Ehipassiko House** for Buddhayana Run 2026 meeting because our usual secretariat office couldn't be used at the time. Honestly, I had wanted to visit this place for quite a while, but never had the chance until this unexpected opportunity came up. Coincidentally, Ehipassiko House had just been renovated.",
    ...
    },
    {
        ...
        story: [
            ...
            "A year ago, on 18 April 2025, I went to Nias with my team from **Sekber PMVBI (Pemuda Buddhayana) Provinsi Sumatera Utara** to conduct **Pelatihan Anak GABI Nias 2025** (Buddhist kids spiritual training) host by **Persaudaraan Muda-mudi Vihara Vimala Dharma (PMVVD)** at **Vihara Vimala Dharma** in Gunungsitoli.",
